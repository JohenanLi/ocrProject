    ...
    export default {
        ...
        data () {
            return {
                ...
                guide_arr: [
                    { img_url: 'http://lighthouse.wolongdanxin.top/images/guide_1.jpg' },
                    { img_url: 'http://lighthouse.wolongdanxin.top/images/guide_2.jpg' },
                    { img_url: 'http://lighthouse.wolongdanxin.top/images/guide_3.jpg' },
                    { img_url: 'http://lighthouse.wolongdanxin.top/images/guide_4.jpg' }
                ]
            }
        },
        created () {
